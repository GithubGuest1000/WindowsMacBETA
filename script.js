...
programs.fireduck = function() { //Mozilla fireduck browser
    ...
    openDialog("DuckFireNet", "Fire", `<form id="urlform" action=""><input type="text" id="url" value="${url}"><input type="submit" value="Go"></form><iframe src="${url}" id="frame">`);
...
//In order to fix error, i put startup script at startup.js! CAT ANSWER ME